...
EOF;
$pid_ex_win = "wmic process where \"Name LIKE '%ffmpeg.exe%'\" get /format:csv 2>nul"; $pid_ex_win_p = "wmic process where \"Name LIKE '%ffplay.exe%'\" get /format:csv 2>nul"; $pid_ex_win_sleep = "wmic process where \"Name LIKE '%php.exe%'\" | findstr rfriends_dontsleep 2>nul"; $pid_dlm_win = ","; $pid_start_win = "Node"; $pid_cline_win = "CommandLine"; $pid_pid_win = "ProcessId"; $pid_cdate_win = "CreationDate"; $pid_ex_linux = "ps -ef"; $pid_dlm_linux = " "; $pid_start_linux = "UID"; $pid_cline_linux = "CMD"; $pid_pid_linux = "PID"; $pid_cdate_linux = "STIME"; $pref_code = array( 1 => "北海道", 2 => "青森県", 3 => "岩手県", 4 => "宮城県", 5 => "秋田県", 6 => "山形県", 7 => "福島県", 8 => "茨城県", 9 => "栃木県", 10 => "群馬県", 11 => "埼玉県", 12 => "千葉県", 13 => "東京都", 14 => "神奈川県", 15 => "新潟県", 16 => "富山県", 17 => "石川県", 18 => "福井県", 19 => "山梨県", 20 => "長野県", 21 => "岐阜県", 22 => "静岡県", 23 => "愛知県", 24 => "三重県", 25 => "滋賀県", 26 => "京都府", 27 => "大阪府", 28 => "兵庫県", 29 => "奈良県", 30 => "和歌山県", 31 => "鳥取県", 32 => "島根県", 33 => "岡山県", 34 => "広島県", 35 => "山口県", 36 => "徳島県", 37 => "香川県", 38 => "愛媛県", 39 => "高知県", 40 => "福岡県", 41 => "佐賀県", 42 => "長崎県", 43 => "熊本県", 44 => "大分県", 45 => "宮崎県", 46 => "鹿児島県", 47 => "沖縄県"); $pref_url = "https://mreversegeocoder.gsi.go.jp/reverse-geocoder/LonLatToAddress"; $gdrive_url = "https://github.com/gdrive-org/gdrive/releases/download/2.1.0/"; $line_url = "https://notify-api.line.me/api/notify"; $line_auth = "--header \"Authorization: Bearer $send_mail_line_token\""; $ffmpeg_buf_radiko = 0; $ffmpeg_buf_radiru = 10; $ffmpeg_buf_timefree = 0; $ffmpeg_buf_radiru_vod = 0; $ffmpeg_buf_radiru_gogaku = 0; $ffmpeg_loglevel = "info"; $ffmpeg_loglevel_timefree = "fatal"; $ffmpeg_tag_opt = "-loglevel error -movflags +faststart  -acodec copy -vcodec copy  -id3v2_version 3 "; $ffmpeg_radiko_opt_win = ' -headers "X-Radiko-AuthToken:%4$s"' . ' -vn' . ' -i %1$s' . ' -t %3$s' . ' -movflags +faststart' . ' -metadata encoder="radiko" ' . ' -bsf:a aac_adtstoasc' . ' -acodec copy' . ' -y'; $ffmpeg_radiru_opt_win = ' -vn' . ' -i %1$s' . ' -t %3$s' . ' -movflags +faststart' . ' -metadata encoder="radiru" ' . ' -bsf:a aac_adtstoasc' . ' -acodec copy' . ' -y'; $ffmpeg_radiru_vod_opt_win = ' -http_seekable 0' . ' -vn' . ' -i %1$s' . ' -movflags +faststart' . ' -metadata encoder="radiru_vod" ' . ' -bsf:a aac_adtstoasc' . ' -acodec copy' . ' -y'; $ffmpeg_radiru_gogaku_opt_win = ' -http_seekable 0' . ' -vn' . ' -i %1$s' . ' -movflags +faststart' . ' -metadata encoder="radiru_vod" ' . ' -bsf:a aac_adtstoasc' . ' -acodec copy' . ' -y'; $ffmpeg_timefree_opt_win = ' -headers "X-Radiko-AuthToken:%4$s"' . ' -vn' . ' -i %1$s' . ' -t %3$s' . ' -movflags +faststart' . ' -metadata encoder="timefree" ' . ' -bsf:a aac_adtstoasc' . ' -acodec copy' . ' -y'; $ffmpeg_radiko_opt_lnx = ' -headers "X-Radiko-AuthToken:%4$s"' . ' -vn' . ' -i %1$s' . ' -t %3$s' . ' -movflags +faststart' . ' -metadata encoder="radiko" ' . ' -bsf:a aac_adtstoasc' . ' -acodec copy' . ' -y'; $ffmpeg_radiru_opt_lnx = ' -vn' . ' -i %1$s' . ' -t %3$s' . ' -movflags +faststart' . ' -metadata encoder="radiru" ' . ' -bsf:a aac_adtstoasc' . ' -acodec copy' . ' -y'; $ffmpeg_radiru_vod_opt_lnx = ' -http_seekable 0' . ' -vn' . ' -i %1$s' . ' -movflags +faststart' . ' -metadata encoder="radiru_vod" ' . ' -bsf:a aac_adtstoasc' . ' -acodec copy' . ' -y'; $ffmpeg_radiru_gogaku_opt_lnx = ' -http_seekable 0' . ' -vn' . ' -i %1$s' . ' -movflags +faststart' . ' -metadata encoder="radiru_vod" ' . ' -bsf:a aac_adtstoasc' . ' -acodec copy' . ' -y'; $ffmpeg_timefree_opt_lnx = ' -headers "X-Radiko-AuthToken:%4$s"' . ' -vn' . ' -i %1$s' . ' -t %3$s' . ' -movflags +faststart' . ' -metadata encoder="timefree" ' . ' -bsf:a aac_adtstoasc' . ' -acodec copy' . ' -y'; $default_editor_cui_win = $bindir.'nano'; $default_editor_gui_win = $bindir.'terapad'; $default_snd_player_win = 'wmplayer'; $default_editor_cui_osx = 'nano'; $default_editor_gui_osx = 'TextEdit.app'; $default_snd_player_osx = 'quicktime player.app'; $default_editor_cui_lnx = 'nano'; $default_editor_gui_lnx = 'gedit'; $default_snd_player_lnx = 'totem'; $default_headless_browser_win_app = 'chrome.exe'; $default_headless_browser_osx_app = 'chromium'; $default_headless_browser_lnx_app = 'chromium-browser'; $default_headless_browser_win_opt = '--headless' . ' --no-sandbox --disable-gpu --disable-software-rasterizer --disable-dev-shm-usage' . ' --disable-extensions --window-size=640,480' . ' --dump-dom'; $default_headless_browser_osx_opt = '--headless' . ' --no-sandbox --disable-gpu --disable-software-rasterizer --disable-dev-shm-usage' . ' --disable-extensions --window-size=640,480' . ' --dump-dom'; $default_headless_browser_lnx_opt = '--headless' . ' --no-sandbox --disable-gpu --disable-software-rasterizer --disable-dev-shm-usage' . ' --disable-extensions --window-size=640,480' . ' --dump-dom'; $debug_fin = 0; 