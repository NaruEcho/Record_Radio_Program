...
EOM;
return ""; } function ht_input($msg,$ty) { global $ht_jump_addr; global $ht_jump_no; global $ht_jump_val2; global $sno; echo_msg(2,""); echo <<<EOM0
...
<p>&nbsp;
<input type="radio" name="val2" value="2" checked>&nbsp;2日間&nbsp;
<input type="radio" name="val2" value="4" checked>&nbsp;4日間&nbsp;
<input type="radio" name="val2" value="7" >&nbsp;7日間&nbsp;
</p>
EOM2;
break; case 3: echo <<<EOM3
<p>&nbsp;
<input type="radio" name="val2" value="1" >&nbsp;1件&nbsp;
<input type="radio" name="val2" value="10" >&nbsp;10件&nbsp;
<input type="radio" name="val2" value="100" checked>&nbsp;100件&nbsp;
<input type="radio" name="val2" value="300" >&nbsp;300件&nbsp;
<input type="radio" name="val2" value="0"   >&nbsp;無制限&nbsp;
</p>
EOM3;
...
EOM4;
} function ht_audio_volume($ty) { global $ht_jump_addr; global $ht_jump_no; global $ht_jump_val2; global $sno; if ($ty == 1) { $v = ht_audio_get_volume(); } else { $v = array(0,0); } echo <<<EOM

<form method='get' action='$ht_jump_addr'>
    <input type="range" id="volume" min="0" max="100" step="10" name='val' style="width:200px;">
...
<p style='width:300px'>再起動ボタンを押してください。</p>
<p>&nbsp;</p>
<button class='btn_ex' type='submit'>再起動</button>
</form>
EOM1;
